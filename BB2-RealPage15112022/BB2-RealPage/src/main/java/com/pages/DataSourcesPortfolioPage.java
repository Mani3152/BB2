...
public class DataSourcesPortfolioPage {
    private WebDriver driver;

    private By dataSources_Link = By.xpath("//a[@role='tab'][text()='Data Sources']");
    ...
    public DataSourcesPortfolioPage(WebDriver driver) {
    ...
    public void clickonDatSources() throws InterruptedException {
        driver.findElement(dataSources_Link).click();
        Thread.sleep(500);
    }
    public void checkDataSources(String keyword) throws InterruptedException {
        ...
        driver.findElements(searchBar).get(1).isDisplayed();
        driver.findElements(searchBar).get(1).sendKeys(keyword);
