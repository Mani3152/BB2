...
public class SimulationSteps {
    ...
    private SimulationPage calPage = new SimulationPage(WebdriverIntializer.getDriver());
    ...
    @When("Take the Cashflow values in Valuations {string}")
...
//        Utils.combineExcel();
    ...
    public void take_the_values_in_the_other_sheets_of_excel(String B0,String B1) throws IOException {
        calPage.datafromPythonOutput(B0,B1);
    }
